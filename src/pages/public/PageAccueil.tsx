...
import {
  ShieldCheck, Lock, Users, BarChart3,
  ChevronRight, Trophy, Eye, Hash,
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="pt-28 md:pt-36 pb-20 md:pb-28 px-4 md:px-8 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 relative overflow-hidden">
        ...
        <div className={`max-w-4xl mx-auto text-center relative transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6 mt-12 md:mt-16 max-w-2xl mx-auto px-4">
            {[
              ...
              <div key={i} className="text-center"
                ...
                <p className="text-blue-300 text-xs md:text-sm mt-1">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16" data-aos="fade-up">
            ...
            <p className="text-gray-500 max-w-xl mx-auto text-sm md:text-base">
              Chaque fonctionnalité a été pensée pour garantir l'intégrité
      ...
      {scrutinsClotures.length > 0 && (
        <section className="py-16 md:py-24 px-4 md:px-8 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8 md:mb-10" data-aos="fade-up">
              ...
              {scrutinsClotures.map((scrutin, i) => (
                <div key={scrutin.id}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-gray-800 text-sm md:text-base">{scrutin.titre}</p>
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-blue-900">
        <div className="max-w-3xl mx-auto text-center" data-aos="zoom-in">
          ...
          <p className="text-blue-200 mb-8 md:mb-10 text-sm md:text-base">
            Inscrivez-vous avec votre matricule officiel et participez
            aux élections de votre université.
          </p>
          <Link to="/inscription"
      ...
      <footer className="bg-blue-950 px-4 md:px-8 py-10 md:py-12">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 md:mb-10">
            ...
            <div>
              <h4 className="text-white font-semibold mb-4">Équipe de développement</h4>
