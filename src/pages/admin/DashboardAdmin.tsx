        ...
        <main className="flex-1 p-4 md:p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Vue synthétique de la plateforme — {new Date().toLocaleDateString('fr-FR', {
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-5 md:p-6 border-b border-gray-100 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-0.5">{scrutins.length} scrutin(s) au total</p>
                  </div>
                  <Link
                    to="/admin/scrutins"
                ...
                <div className="divide-y divide-gray-50">
                    ...
                    <div key={scrutin.id}
                      ...
                      <div className="flex items-center gap-4 min-w-0">
                        <div className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${
                          scrutin.statut === 'OUVERT'   ? 'bg-green-500' :
                          scrutin.statut === 'BROUILLON' ? 'bg-amber-400' :
                          'bg-gray-300'
                        }`} />
                  ...
                  {scrutins.length === 0 && (
                    <div className="p-12 text-center">
                      ...
                      <p className="text-gray-400 text-sm">Aucun scrutin créé pour le moment.</p>
                      <Link
                        to="/admin/scrutins"
